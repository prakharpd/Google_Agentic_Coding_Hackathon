...
def _build_summary_prompt(
    ...
    prompt = (
        ...
        "CRITICAL: In the EDA Findings Per Column table, you MUST use \n"
        "EXACTLY these computed values. Do not round, approximate or \n"
        "change them:\n"
        f"{json.dumps(eda_stats, indent=2)}\n"
        "Copy these exact numbers into the table. Any deviation will \n"
